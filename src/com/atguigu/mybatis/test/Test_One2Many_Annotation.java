...
public class Test_One2Many_Annotation {
	...
	public void testMany2One() {
		...
		try {
			...
			EmpMapperAnnotation empMapper = sqlSession.getMapper(EmpMapperAnnotation.class);
	...
	public void testOne2Many() {
		...
		try {
			sqlSession = sqlSessionFactory.openSession();
			DeptMapperAnnotation deptMapper = sqlSession.getMapper(DeptMapperAnnotation.class);
